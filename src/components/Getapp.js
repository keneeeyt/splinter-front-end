...
const Getapp = () => {
  return (
    <div className="p-4">
    <h2 className="text-3xl text-black font-extrabold my-3 text-center">Get the app</h2>
    <div className="flex w-full style-flex-col md:flex-row gap-y-4 gap-x-8 sm:items-center md:justify-center"><Link to = '/'
            target="_blank"
            className="flex items-center justify-center w-full px-5 py-3 text-center text-white bg-white rounded-2xl sm:rounded-2xl md:w-auto"
            rel="noreferrer"><svg className="w-7" viewBox="0 0 40 45" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-col ml-2 leading-4 text-left md:ml-3">
                <span className="text-sm text-black">Get it on</span><span className="text-base font-semibold text-black">App Store</span>
            </div>
        </Link><Link to = '/' target="_blank"
            className="flex items-center justify-center w-full px-5 py-3 text-center text-white bg-white rounded-2xl sm:rounded-2xl md:w-auto"
            rel="noreferrer"><svg className="w-7" viewBox="-9 0 274 274" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
                    <path
            ...
            <div className="flex flex-col ml-2 leading-4 text-left md:ml-3">
                <span className="text-sm text-black">Get it on</span><span className="text-base font-semibold text-black">Play Store</span>
            </div>
        </Link></div>
</div>
  )
